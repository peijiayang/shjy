...
public class JwtUtils {
     ...
     * @return
     */
    public static String createJWT(String jwtSec, long ttlMillis, String username,Integer userId) {
 ...
 */
    /*public class JwtUtils {
        ...
        *//**
         ...
         *
         *//*
        public static boolean verify(String jwtSec,String token){


            try {
                JWTVerifier verifier = JWT.require(Algorithm.HMAC256(jwtSec)).withIssuer("auth0").build();
